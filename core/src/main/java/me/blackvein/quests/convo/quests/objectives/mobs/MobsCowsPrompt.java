...
public class MobsCowsPrompt extends QuestsEditorStringPrompt {
    ...
    public MobsCowsPrompt(final MobsPrompt mobsPrompt, final ConversationContext context) {
        super(context);
        ...
        if (!input.equalsIgnoreCase(Lang.get("cmdCancel")) && !input.equalsIgnoreCase(Lang.get("cmdClear"))) {
            try {
                ...
                if (i < 0) {
                    ...
                    context.setSessionData(mobsPrompt.pref + CK.S_COW_MILK, i);
                }
            ...
            context.setSessionData(mobsPrompt.pref + CK.S_COW_MILK, null);
        }

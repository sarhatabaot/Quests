...
public class MobsRadiiPrompt extends QuestsEditorStringPrompt {
    ...
    public MobsRadiiPrompt(final MobsPrompt mobsPrompt, final ConversationContext context) {
        super(context);
    ...
    public Prompt acceptInput(final @NotNull ConversationContext context, final String input) {
        ...
        if (!input.equalsIgnoreCase(Lang.get("cmdCancel"))) {
            ...
            context.setSessionData(mobsPrompt.pref + CK.S_MOB_KILL_LOCATIONS_RADIUS, radii);
        }

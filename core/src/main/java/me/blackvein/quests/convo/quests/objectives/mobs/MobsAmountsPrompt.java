...
public class MobsAmountsPrompt extends QuestsEditorStringPrompt {
    ...
    public MobsAmountsPrompt(final MobsPrompt mobsPrompt, final ConversationContext context) {
        super(context);
    ...
    public Prompt acceptInput(final @NotNull ConversationContext context, final String input) {
        ...
        if (!input.equalsIgnoreCase(Lang.get("cmdCancel"))) {
            ...
            context.setSessionData(mobsPrompt.pref + CK.S_MOB_AMOUNTS, mobAmounts);
        }
